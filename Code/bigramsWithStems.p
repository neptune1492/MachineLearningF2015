...
chars = ['@','\\','/','#','?','!','.','\\x']
alpha = 0.1
goodPath = '/export/mathcs/home/student/e/ebrenna8/Kaggle/StemFiles/gAll'
badPath = '/export/mathcs/home/student/e/ebrenna8/Kaggle/StemFiles/bAll'
f = open(goodPath, 'r')
...
path = "/export/mathcs/home/student/e/ebrenna8/Kaggle/StemFiles/dev/"
...
for f in sorted(os.listdir(path), key=natural_sort_key):
       ...
       #         print str(cnt) + 'correct' 
        if (valP == 0) and (valN ==0):
                print 'error - both counts zero'
        elif (valP > valN) and 'g' in f:
                
                print valP
                print valN
                print fileText.name
                print str(cnt) + 'correct'
        elif (valP > valN) and 'b' in f:
                print str(cnt) + 'incorrect'
        elif (valP <= valN) and 'b' in f:
                print valP
                print valN
